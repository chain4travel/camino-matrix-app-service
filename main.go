...
// TODO@ old comment, reverify
// ! appservice will not process events that happened while app-service wasn't running
...
// ! and NO FURTHER event will be sent until app-service will response without error
